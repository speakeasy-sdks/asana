 ...
 */
export class WebhookUpdateRequestFilters extends SpeakeasyBase {
    /**
...
export class WebhookUpdateRequest extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata({ elemType: WebhookUpdateRequestFilters })
    @Expose({ name: "filters" })
    @Type(() => WebhookUpdateRequestFilters)
