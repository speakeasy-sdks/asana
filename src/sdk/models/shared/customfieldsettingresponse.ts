 ...
 */
export enum CustomFieldSettingResponseCustomFieldAsanaCreatedField {
 ...
 */
export enum CustomFieldSettingResponseCustomFieldCustomLabelPosition {
    Prefix = "prefix",
    Suffix = "suffix",
}
 ...
 */
export enum CustomFieldSettingResponseCustomFieldFormat {
    Currency = "currency",
 ...
 *
 */
export enum CustomFieldSettingResponseCustomFieldResourceSubtype {
    Text = "text",
    Enum = "enum",
 ...
 *
 */
export enum CustomFieldSettingResponseCustomFieldType {
    Text = "text",
    Enum = "enum",
    MultiEnum = "multi_enum",
    Number = "number",
...
export class CustomFieldSettingResponseCustomField extends SpeakeasyBase {
    ...
    asanaCreatedField?: CustomFieldSettingResponseCustomFieldAsanaCreatedField;
    ...
    customLabelPosition?: CustomFieldSettingResponseCustomFieldCustomLabelPosition;
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "format" })
    format?: CustomFieldSettingResponseCustomFieldFormat;
    ...
    resourceSubtype?: CustomFieldSettingResponseCustomFieldResourceSubtype;
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "type" })
    type?: CustomFieldSettingResponseCustomFieldType;
}
